...
export const CATEGORY_ICONS: Record<string, React.ReactNode> = {
  Maquillaje: <img src={lipstickGif} alt="" className="category-emoji-img" width={168} height={160} loading="lazy" />,
  ...
  Ropa: <img src={dressImg} alt="" className="category-emoji-img category-dress" width={224} height={224} loading="lazy" />,
  'Dulces Asiáticos': <img src={treatGif} alt="" className="category-emoji-img category-treat" width={224} height={188} loading="lazy" />,
  'Peluches y Figuras': <img src={hoppingBear} alt="" className="category-emoji-img category-bear" width={180} height={180} loading="lazy" />,
